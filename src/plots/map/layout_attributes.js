...
var attrs = (module.exports = overrideAll(
    {
        ...
        layers: templatedArray('layer', {
            ...
            sourcetype: {
                ...
                dflt: 'geojson',
                description: ['Sets the source type for this layer,', 'that is the type of the layer data.'].join(' ')
            },
            ...
            sourceattribution: {
                valType: 'string',
                description: ['Sets the attribution for this source.'].join(' ')
            },
            ...
            symbol: {
                ...
                text: {
                    valType: 'string',
                    dflt: '',
                    description: ['Sets the symbol text (map.layer.layout.text-field).'].join(' ')
                },
                placement: {
                    valType: 'enumerated',
